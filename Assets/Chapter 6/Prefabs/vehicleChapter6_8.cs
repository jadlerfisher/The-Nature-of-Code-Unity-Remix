...
public class vehicleChapter6_8 : MonoBehaviour
{
    ...
    */
    ...
    public Vector3 separate(List<GameObject> vehicles)
    {
        ...
        {
            float d = Vector3.Distance(location, other.GetComponent<vehicleChapter6_8>().location);
  
            if ((d > 0) && (d < desiredSeparation))
            {
                Vector3 diff = location - other.GetComponent<vehicleChapter6_8>().location;
