...
public class Chapter6Fig7 : MonoBehaviour
{
    ...
    private vehicleChapter6_7 vC67;
    ...
    void Update()
    {
        ...
        {
           //vehicle.GetComponent<vehicleChapter6_7>().seek(target.transform.position);
            vehicle.GetComponent<vehicleChapter6_7>().separate(vehicles);
